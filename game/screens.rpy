...
style say_label:
    ...
    yalign 0.5
    outlines [(3, "#454545", 0, 0), (1, "#454545", 1, 1)]
...
style game_menu_label_text:
    ...
    size gui.title_text_size
    color "#fff"
    outlines [(6, "#454545", 0, 0), (3, "#454545", 2, 2)]
    yalign 0.5
...
style navigation_button_text:
    ...
    color "#fff"
    outlines [(4, "#454545", 0, 0), (2, "#454545", 2, 2)]
    hover_outlines [(4, "#9c0907", 0, 0), (2, "#9c0907", 2, 2)]
    insensitive_outlines [(4, "#a3a3a3", 0, 0), (2, "#a3a3a3", 2, 2)]
...
screen game_menu_h(title, scroll=None):
    ...
    frame:
        ...
        frame:
            style "game_menu_navigation_frame"
        frame:
            style "game_menu_content_frame_h"
            if scroll == "viewport":
                viewport:
                    scrollbars "vertical"
                    mousewheel True
...
screen about():
    ...
    use game_menu(_("Credits")):
        ...
        vbox:
            xpos -0.2
            ypos 50
            label "{a=https://twitter.com/WretchedTeam}{b}{u}VARIOUS ARTISTS{/u}{/b}{/a}" xalign 0.5
            text _("Cade Bedlam - Writing") xalign 0.5
            text _("F i T - Writing/Coding/Art") xalign 0.5

        vbox:
            xpos 550
            ypos 50
            label "{b}{u}MUSIC{/u}{/b}" xalign 0.5
            text _("Jan Hehr") xalign 0.5
            text _("Jake Kaufman") xalign 0.5
            text _("Charles Stiles") xalign 0.5
            text _("ascoiris") xalign 0.5

        vbox:
            xpos 180
            ypos 350
            label "{b}{u}SPECIAL THANKS{/u}{/b}" xalign 0.5
            text _("Willnisian") xalign 0.5
            text _("Oliver") xalign 0.5
            text _("Crimsin") xalign 0.5
...
style page_label_text:
    color "#fff"
    outlines [(2, "#454545", 0, 0), (0, "#454545", 0, 0)]
    xpos -130
    ypos -20
    text_align 0.5
    layout "subtitle"
...
screen history():
    tag menu
    predict False
    use game_menu_h(_("History"), scroll=("vpgrid" if gui.history_height else "viewport")):
